...
author: "Gina (Evangeline) Reynolds, Jan 2026, ggplot2 extenders"
output:
...
#### .tiny[Gina (Evangeline) Reynolds | 2026-01 | ASA, COWY, Image credit: Ales Krivec, Upsplash]
...
# Online Posit Conf speaker training, July 22, 2025: "Give a Ted Talk like Sathiya"
...
```{r, fig.height=3}
two_clusters_5tsne & # contains all six of the 'hello world of tsne' specifications
...
## `aes(dims = dims())` and `unpack()` implementation

- geom_umap(aes(dims = dims(var1:var10)))

- ggpcp's approach (Heike)?
- ggswim approach (Teun and Rich, via June)?
- ggincerta (Maggie and Emi)?

## on the dimred technical side

- layer_pca/layer_tsne/layer_umap requirements (Cory, Joyce, tsne authors, Leland McInnes)
- borrow internals with tidymodels for consistency? (tidymodels team...)
